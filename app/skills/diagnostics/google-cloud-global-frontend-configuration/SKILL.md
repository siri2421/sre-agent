...
metadata:
  category: Networking
description: >-
  Guides agents through designing, discovering, deploying, and troubleshooting Google Cloud global external Application Load Balancers, Cloud CDN, Cloud Armor WAF, and Service Extensions. Use when configuring or triaging global external load balancers and edge security. Don't use for purely internal load balancing.
---
